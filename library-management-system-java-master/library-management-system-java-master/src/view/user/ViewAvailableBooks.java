...
public class ViewAvailableBooks extends JFrame {
    ...
    public ViewAvailableBooks(JFrame parentFrame) {
        ...
        headerPanel.setBackground(new Color(102, 153, 255)); // Warna biru
        ...
        booksTable.getTableHeader().setBackground(new Color(102, 153, 255));
        ...
        footerPanel.setBackground(new Color(102, 153, 255));
    ...
    private void loadBooksFromDatabase() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM books WHERE available = 1");
